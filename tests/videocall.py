...
driver.find_element(By.CSS_SELECTOR, "#radix-\:r0\:-trigger-video").click()
...
camera_button_colour = Color.from_string(driver.find_element(By.CSS_SELECTOR, "#root > div._room_17y9i_1 > div._toolbar_10g91_1 > button:nth-child(1) > div._button_183cn_6._button-white_183cn_25").value_of_css_property('color'))
assert camera_button_colour.hex == "#000000"
driver.find_element(By.CSS_SELECTOR, "#root > div._room_17y9i_1 > div._toolbar_10g91_1 > button:nth-child(1) > div._button_183cn_6._button-white_183cn_25").click()
sleep(1)
...
driver.find_element(By.CSS_SELECTOR, "#root > div._room_17y9i_1 > div._toolbar_10g91_1 > button:nth-child(2) > div._button_183cn_6._button-white_183cn_25").click()
sleep(1)
mic_button_colour = Color.from_string(driver.find_element(By.CSS_SELECTOR, "#root > div._room_17y9i_1 > div._toolbar_10g91_1 > button:nth-child(2) > div._button_183cn_6._button-white-red_183cn_30").value_of_css_property('color'))
assert mic_button_colour.rgba == 'rgba(220, 38, 37, 1)'
sleep(1)
driver.find_element(By.CSS_SELECTOR, "#root > div._room_17y9i_1 > div._toolbar_10g91_1 > button:nth-child(4) > div._button_183cn_6._button-red_183cn_35").click()
